...
function stay() {
    ...
    // check who has the larger score
    
    if (playerAmount > dealerAmount) {
        win()
    }else if (dealerAmount >= playerAmount && dealerAmount < 21){
        bust()
    }
...
function blackjack(card, who) {
    ...
    if (card == 'Ace of spades' || card == 'Ace of hearts' || card == 'Ace of clubs' || card == 'Ace of diamonds') {
        ...
        if (who == 'player') {
           ...
           let eleven = document.createElement("button")
           one.innerHTML = "1"
           eleven.innerHTML= "11"
            one.id = "one"
            eleven.id = "eleven"
           document.getElementById("Ace").append(one)
           document.getElementById("Ace").append(eleven)

            document.getElementById("one").addEventListener("click", One)
            document.getElementById("eleven").addEventListener("click", Eleven)

            let hit = document.getElementById('Draw');
...
function bust() {
    document.getElementById('Outcome').innerHTML = 'You lose, click here to reset'
    let hit = document.getElementById('Draw');
    let stay = document.getElementById('stay');
    hit.remove()
    stay.remove()
    document.getElementById('Outcome').addEventListener('click', Reset)
}

function win() {
    document.getElementById('Outcome').innerHTML = 'You win, click here to reset'
    let hit = document.getElementById('Draw');
    let stay = document.getElementById('stay');
    hit.remove()
    stay.remove()
...
function oneOrEleven(num) {
    playerAmount = playerAmount+ num
    document.getElementById('you').innerHTML = playerAmount;
    let uno = document.getElementById('one')
    let elf = document.getElementById('eleven')
    uno.remove()
    elf.remove()
    
    // re add the hit and stay buttons
    ...
    hit.id = "Draw"
    Stay.id = "stay"
    document.getElementById("hitAndStay").append(hit)
    document.getElementById("hitAndStay").append(Stay)
